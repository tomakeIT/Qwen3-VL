...
DATASET_ROOT="/home/jialeng/LightwheelData/Robocasa_lerobot_6tasks"
OUTPUT_ROOT="/home/jialeng/LightwheelDataFast/Robocasa_lerobot_6tasks_with_progress_profiling6"
...
python3 -m inference.cli.backfill \
    --adapter $ADAPTER \
    ...
    --limit-episodes 4 \
    --profile-output "./backfill_profile_updated3.prof"